        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    department_uuid = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    id = table.Column<int>(type: "int", nullable: false),
                    create_at = table.Column<DateTime>(type: "datetime", nullable: true),
                    update_at = table.Column<DateTime>(type: "datetime", nullable: true),
                    create_by = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_staffs", x => x.uuid);
                    table.ForeignKey(
                        name: "fk_staffs_departments_department_uuid",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_staffs_department_uuid",
                table: "staffs",
